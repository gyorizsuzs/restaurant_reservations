  ...
  function (
    ...
    return Controller.extend("sap.ui.demo.walkthrough.controller.Page", {
      onInit: function () {
        ...
        oModel.setData({
          ...
          bookings: [
            ...
            {
              restaurant: "Côte Royal Festival Hall",
              startDate: new Date("2023", "4", "1", "12", "0"),
              endDate: new Date("2023", "4", "1", "14", "0"),
      ...
      handleAppointmentSelect: function (oEvent) {
        var oBooking = oEvent.getParameter("booking"),
          oStartDate,
          oEndDate,
          oTrimmedStartDate,
          oTrimmedEndDate,
        ...
        oStartDate = oBooking.getStartDate();
        oEndDate = oBooking.getEndDate();
